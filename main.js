...
function sortRows(cellIndex, type) {
  ...
  for (let i = 0; i < rowsArray.length; i++) {
    ...
    if (temp[i].cells[cellIndex].innerHTML != 
...
button.onclick = function() {  
  ...
  // validation
  !name ? alert("Please, enter contact`s name") :
  !age ? alert("Please, enter contact`s age") :
  !city ? alert("Please, enter contact`s city") :
  !country ? alert("Please, enter contact`s country") :
